...
PAGES.data = (app) => {
  ...
  app.innerHTML = '<div class="container">'+
    ...
    '<div class="data-entry-tile green" data-go="data-summary"><div class="dt-ic">📊</div><div class="dt-info"><div class="dt-name">周/月数据总结</div><div class="dt-desc">一周与一个月的趋势汇总</div></div><div class="dt-arrow">›</div></div>'+'<div class="data-entry-tile orange" data-go="send-history"><div class="dt-ic">🏥</div><div class="dt-info"><div class="dt-name">向医师发送病史</div><div class="dt-desc">发送个人健康信息给指定医师</div></div><div class="dt-arrow">›</div></div>'+
    '</div>';
  ...
  app.querySelector('[data-go="send-history"]').onclick = () => navigate('send-history');
};
